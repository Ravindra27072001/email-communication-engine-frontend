...
<div class="container p-5">
    <h1 class="mb-3 pb-3 text-center">Add an email account</h1>
...
<div class="row g-0">
    <div class="col-md-6 col-lg-5 d-none d-md-block bg-warning rounded">
        <img src="../images/addAccount.png" alt="login form" class="img-fluid"
            style="border-radius: 1rem 0 0 1rem;margin-left: 10px; margin-top: 50px; margin-bottom: 40px;" />
    </div>
        ...
        <div class="card-body bg-warning rounded">
            <form @submit.prevent="submit">
                ...
                <div class="form-outline">
                    ...
                    <select v-model="listName" class="form-select form-outline"
